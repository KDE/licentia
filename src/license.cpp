...
License::License(QString key, QString name, QString spdx, QString description, QString licenseImplementation, QString spdxImplementation, QJsonArray permissions, QJsonArray conditions, QJsonArray limitations, QJsonArray projectsUsing, QString body)
{
    m_key = key;
    m_name = name;
    m_spdx = spdx;
    m_description = description;
    m_licenseImplementation = licenseImplementation;
...
QString License::licenseImplementation()
{
    return m_licenseImplementation;
}
...
License License::fromJson(const QJsonObject &obj)
{
    ...
    if (key == "afl-3.0") {
        ...
        licenseImplementation = i18n("Create a text file (typically named LICENSE or LICENSE.txt) in the root of your source code and copy the text of the license into the file.");
    } else if (key == "0bsd") {
        ...
        licenseImplementation = i18n("Create a text file (typically named LICENSE or LICENSE.txt) in the root of your source code and copy the text of the license into the file. It is also acceptable to solely supply a link to a copy of the license, usually to the canonical URL for the license.");
        ...
        licenseImplementation = i18n("Create a text file (typically named COPYING, as per GNU conventions) in the root of your source code and copy the text of the license into the file.");
        ...
        licenseImplementation = i18n("This license is an additional set of permissions to the GNU GPLv3 license. Follow the instructions to apply the GNU GPLv3, in the root of your source code. Then add another file named COPYING.LESSER and copy the text.");
        ...
        licenseImplementation = i18n("Create a text file (typically named UNLICENSE or UNLICENSE.txt) in the root of your source code and copy the text of the license disclaimer into the file.");
    }
